...
import com.autopertdiagram.pojo.User;
 ...
 * 
 * @see com.autopertdiagram.pojo.User
...
public class UserDAO extends BaseHibernateDAO {
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) getSession().get(
					"com.autopertdiagram.pojo.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) getSession().createCriteria(
					"com.autopertdiagram.pojo.User").add(create(instance))
					.list();
	...
	public List<User> findByPower(Object power) {
