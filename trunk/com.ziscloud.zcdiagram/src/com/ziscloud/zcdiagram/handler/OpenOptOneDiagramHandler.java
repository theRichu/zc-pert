...
public class OpenOptOneDiagramHandler extends AbstractHandler implements IHandler {
	private static final Logger LOGGER = Logger
			.getLogger(OpenOptOneDiagramHandler.class);
			...
			if (obj != null) {
				...
				try {
					page.openEditor(new DiagramEditorInput(project,
							DiagramEditorInput.MODELONE), DiagramEditor.ID);
